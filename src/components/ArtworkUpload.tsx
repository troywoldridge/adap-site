...
export default function ArtworkUpload({
  ...
  const handleFiles = useCallback(
    ...
    [cartId, lineId, side, sideType, onUploaded, showContinueEvenIfNotImage],
  );
    ...
    <div className={className}>
      ...
      {preview ? (
        ...
        <div
          ...
          onDrop={onDrop}
          className={[
            "relative grid place-items-center min-h[160px] min-h-[160px] rounded-xl border-2 border-dashed transition",
