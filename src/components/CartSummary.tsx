...
/* ---- Local minimal types for what CartSummary needs ---- */
type MiniLine = {
...
/** Props we expect the Shipping Estimator to accept (local, explicit) */
type EstimatorProps = {
  lines: MiniLine[];
  store: StoreCode;
...
/** Cast the imported component to a component with EstimatorProps */
const Estimator = CartShippingEstimator as unknown as React.ComponentType<EstimatorProps>;
...
export default function CartSummary({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 order-summary">
      {/* Title */}
      ...
      <div className="mt-4">
        ...
        <div className="estimator estimator--compact bg-white border border-gray-200 rounded-xl p-4">
          <Estimator
            /* Inputs align to SinaLite API fields (ShipCountry, ShipState, ShipZip) */
            lines={lines}
            store={store}
