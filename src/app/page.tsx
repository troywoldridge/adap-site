...
// ✅ If you currently have themeColor in metadata export for "/",
// Next 15 wants themeColor moved to viewport export.
  ...
  return (
    <HomeShellClient>
      <main>
        ...
        <Suspense
          fallback={
            <div className="mx-auto max-w-7xl px-4 py-10" aria-label="Loading hero">
