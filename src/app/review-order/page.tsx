...
import type { Category, Subcategory } from "@/types/catalog"; // or wherever you keep the interfaces
...
export default async function ReviewOrderPage() {
  ...
  if (!orderSession?.productId) {
    return (
      <main className="container review-order">
        ...
        <p><Link href="/" className="btn btn-primary">Start Shopping</Link></p>
      </main>
    );
  }
  ...
  // Normalize IDs and make strings/numbers acceptable everywhere
  ...
  // Build Category/Subcategory with REQUIRED fields from your interfaces
  const category: Category = {
    id: categoryId, // string | number OK
  ...
  // Product UI bits (safe fallbacks)
  ...
  return (
    <main className="container review-order">
        ...
        <div className="row">
          ...
          <div className="col-main">
            ...
            <div className="actions">
              <Link href={`/products/${productIdStr}`} className="link">Edit Product</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="card">
        ...
        {uploads.length ? (
          ...
          <p className="muted">
            ...
            <Link href={`/products/${productIdStr}/upload-artwork`} className="link">Upload now</Link>
          </p>
        )}
      </section>
      ...
      <section className="card">
        ...
        {shipping ? (
          <>
            ...
            <div className="actions">
              <Link href={`/products/${productIdStr}`} className="link">Change Shipping</Link>
            </div>
          </>
        ) : (
      ...
      <section className="final-actions">
        <Link href={`/products/${productIdStr}`} className="btn btn-secondary">Back</Link>
